// NYC Air Quality D3 Contours Script
// Debug: Check if container exists
const container = d3.select("#air-quality-map");
if (container.empty()) {
  console.error("Container #air-quality-map not found!");
} else {
  console.log("Container #air-quality-map found, proceeding with visualization");
  ...
  console.log("Loading NYC air quality data...");
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  console.log('Module 3: Data Visualization initialized');
}); 