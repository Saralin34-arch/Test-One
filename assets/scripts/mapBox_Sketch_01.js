...
var mapboxSketch = function() {
  ...
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FyYWxpbjMwNCIsImEiOiJjbWRjY2M4OTYwOWZiMmxvazMyOWkwcW0xIn0.02wSv2MXs9AGoBqLdi6wQg'; // Replace with your own token <---------------------------------------------------------------------------------------------
  ...
  const map = new mapboxgl.Map({
      ...
      // - 'dark-v11': Dark theme
      style: 'mapbox://styles/saralin304/cmdccrmhi02fl01s4g9cm4phd', // Reverted to previous custom style URL
      ...
      center: [-73.94723, 40.7462], // Center from the provided style link
      ...
      zoom: 12.18, // Zoom from the provided style link
  ...
  document.getElementById('resetView').addEventListener('click', () => {
      ...
      map.flyTo({
          center: [-73.94723, 40.7462],  // Updated to match custom style
          zoom: 12.18,                   // Updated to match custom style
          pitch: 0,
          bearing: 0,
          duration: 2000
      });
